            ...
            if (ModelState.IsValid)
            {
                ...
                {                    
                    ...
                    return Content("<link href='" + hh + "' rel='stylesheet' type='text/css'/>" +
                                   ...
                                   "text: 'The office doctor already exist and has been assigned to another " +
                                   "doctor, please try again, you must assign diferent office'," +
                                   "type: 'error'," +
                                   ...
                                   "{swal(''," +
                                    "''," +
                                    "'success', window.location.href='/Account/Register')});</script>");                    
                }
                UsersHelper.CreateUserASP(model);                
