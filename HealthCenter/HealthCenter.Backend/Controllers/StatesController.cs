...
namespace HealthCenter.Backend.Controllers
{
    public class StatesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "StateId,stateName")] State state)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StateId,stateName")] State state)
        {
            if (ModelState.IsValid)
            {
